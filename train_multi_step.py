...
def main(runid):
    ...
    if args.train:
        ...
        for i in range(1,args.epochs+1):
            ...
            his_train_mape.append(mtrain_mape)
            his_train_rmse.append(mtrain_rmse)
            his_valid_loss.append(mvalid_loss)
            his_valid_mape.append(mvalid_mape)
        ...
        col_name = ['his_train_loss','his_train_mape','his_train_rmse','his_valid_loss','his_valid_mape','his_valid_rmse']
...
if __name__ == "__main__":
    ...
    armse = np.mean(rmse,axis=0)

    smae = np.std(mae,axis=0)
